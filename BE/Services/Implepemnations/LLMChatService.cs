    ...
    public class LLMChatService : ILLMChatService
    {
        ...
        public async Task<IActionResult> PromptChat(int userId)
        {
            ...
            string prompt = "Качил съм данни за разходи по категории за един потребител и общите разходи и приходи. "
                ...
                + "ВАЖНО ЗА ОТГОВОРА: Не включвай никакъв въвеждащ или заключителен текст и не използвай никакви специални символи,емоджита и тн. Отговорът трябва да съдържа само три булета без заглавия, без допълнителни обяснения преди или след тях. "
                + "Във формат:\n" +
                "• съвет 1\n" +
                "• съвет 2\n" +
                "• съвет 3";
